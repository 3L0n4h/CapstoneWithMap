                    ...
                    if (getItemViewType(position) == R.layout.pending_items) {
                        ...
                        viewHolder.CommentPostButton.setOnClickListener(new View.OnClickListener() {
                            ...
                            public void onClick(View v) {
                                Intent commentsIntent = new Intent(PendingPost.this, CommentActivity.class);
...
//                                            mDatabaseLikes.child("Fullname").getValue().toString();
                        ...
                        viewHolder.mView.setOnClickListener(new View.OnClickListener() {
                            @Override
                            public void onClick(View view) {
//                                Intent singleActivity = new Intent(PendingPost.this, SinglePostActivity.class);
...
//                    KAPAG WALANG IMAGE CONDITION
    ...
    public static class PostViewHolder extends RecyclerView.ViewHolder {
        ...
        public PostViewHolder(View itemView) {
            super(itemView);
            mView = itemView;
            mLikeButton = (ImageButton) mView.findViewById(R.id.like_btn3);
            CommentPostButton = (ImageButton) mView.findViewById(R.id.comment_btn3);
            DisplayNoOfLikes = (TextView) mView.findViewById(R.id.display_no_of_likes3);
            txtFileName = (TextView) mView.findViewById(R.id.txtfile);
//
            mLikeButton2 = (ImageButton) mView.findViewById(R.id.like_btn4);
            CommentPostButton2 = (ImageButton) mView.findViewById(R.id.comment_btn4);
            DisplayNoOfLikes2 = (TextView) mView.findViewById(R.id.display_no_of_likes4);
