...
public class Register extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        inputFirstname = (TextInputLayout) findViewById(R.id.inputFirst);
        editFirst = (EditText) findViewById(R.id.editFirst);
        editFirst.addTextChangedListener(new MyTextWatcher(editFirst));
        inputLastname = (TextInputLayout) findViewById(R.id.inputLast);
        ...
        inputStud = (TextInputLayout) findViewById(R.id.inputStud);
        editStud = (EditText) findViewById(R.id.editStud);
...
//        spinner.setAdapter(new ArrayAdapter<String>(this, android.R.layout.simple_spinner_dropdown_item, CourseData.courseName));
        final TextView datee = (TextView) findViewById(R.id.date);
            ...
            mAuth.createUserWithEmailAndPassword(email, password).addOnCompleteListener(new OnCompleteListener<AuthResult>() {
                ...
                public void onComplete(@NonNull Task<AuthResult> task) {
                    if (task.isSuccessful()) {
                        ...
                        final String phone = "+63"+editPhone.getText().toString().trim();
